...
// Dummy data for email verification
const validEmails = ['test@example.com', 'user@example.com']; // Example valid emails
...
app.get('/profile/:id/edit', (req, res) => {
  res.send(`
    <div class="container mx-auto py-8 max-w-lg" hx-target="this" hx-swap="outerHTML">
  ...
  res.send(`
    <div class="container mx-auto py-8 max-w-lg" hx-target="this" hx-swap="outerHTML">
      <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <button hx-get="/profile/1/edit" class="bg-indigo-700 text-white font-bold w-full py-2 px-4 rounded-lg mt-4 hover:bg-indigo-600">Click To Edit</button>
      </div>
    </div>
  `);
});
